...
*/
    ...
    case GUI_App::EAppMode::Editor:
        ...
        m_taskbar_icon->SetIcon(wxIcon(Slic3r::var("logo_360.ico"), wxBITMAP_TYPE_ICO), "MetaSlicer");
        break;
...
//Meta3D: Stupid output function for my use
void MainFrame::output_through_framename(string val)
{
    this->wxTopLevelWindow::SetTitle(val);
    return;
...
void MainFrame::update_side_button_style()
{
    ...
    m_slice_btn->SetCornerRadius(FromDIP(8));
    m_slice_btn->SetExtraSize(wxSize(FromDIP(38), FromDIP(10)));
    m_slice_btn->SetMinSize(wxSize(-1, FromDIP(24)));

    m_slice_option_btn->SetTextLayout(SideButton::EHorizontalOrientation::HO_Center);
    m_slice_option_btn->SetCornerRadius(FromDIP(8));
    ...
    m_print_btn->SetCornerRadius(FromDIP(8));
    ...
    m_print_option_btn->SetCornerRadius(FromDIP(8));
...
void MainFrame::init_menubar_as_editor()
{
    ...
    wxMenu* fileMenu = new wxMenu;
    {
        ...
        wxMenuItem* recent_projects_submenu = append_submenu(fileMenu, recent_projects_menu, wxID_ANY, _L(" projects"), "");

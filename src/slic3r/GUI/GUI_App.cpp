...
public:
    ...
    void Decorate(wxBitmap& bmp)
    {
        ...
        auto bs_version = wxString::Format("Based on BambuStudio, PrusaSlicer and OrcaSlicer").ToStdString();
        ...
        wxBitmap logo_bmp = *bmp_cache.load_svg("logo_360", logo_size, logo_size);
...
private:
    ...
    struct ConstantText
    {
        ...
        {
            // title
            title = wxGetApp().is_editor() ? "MetaSlicer" : GCODEVIEWER_APP_NAME;

            // dynamically get the version to display
            version = _L("Ver.") + " " + GUI_App::format_display_version();
...
void GUI_App::UpdateDarkUI(wxWindow* window, bool highlited/* = false*/, bool just_font/* = false*/)
{
    ...
    //window->SetBackgroundColour(RGB(0x91,0x13,0x13));
    if (m_is_dark_mode) {

...
void GLCanvas3D::LayersEditing::render_variable_layer_height_dialog(const GLCanvas3D& canvas) {
    ...
    ImGui::PushStyleColor(ImGuiCol_SliderGrabActive, ImVec4(1.0f, 0.68f, 0.00f, 1.00f));
    ...
    ImGui::SetCursorPosX(input_align);
    ImGui::PushItemWidth(input_box_width);
    ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(1.0f, 0.68f, 0.00f, 1.00f));
    ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(1.0f, 0.68f, 0.00f, 0.00f));
    ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(1.0f, 0.68f, 0.00f, 0.00f));
...
//#endif
        ...
        if (layer_editing_object_idx != -1 && m_layers_editing.bar_rect_contains(*this, pos(0), pos(1))) {
            ...
            if (evt.LeftDown() && evt.ShiftDown() && m_picking_enabled && m_layers_editing.state != LayersEditing::Editing) {
                ...
                //Meta3D: Here the volume selection hapening by mouse click
        ...
        if (m_layers_editing.state != LayersEditing::Unknown) {
            ...
            //Meta3D: This function is about dragging object. Duh!
            // BBS
...
std::vector<Vec2f> GLCanvas3D::get_empty_cells(const Vec2f start_point, const Vec2f step)
{
    ...
    //wxGetApp().mainframe->output_through_framename(build_volume.area());
...
//function for rendering backgrounds

...
public:
    Coordinates(); 
    void set_coordinates_drop(wxCoord x, wxCoord y);
    std::vector<wxCoord> get_coordinates_drop();
...
public:
    ...
    //Meta3D: Put this vector in private later
    std::vector<ModelInstance*> copy_instances;  
    void test(double d);

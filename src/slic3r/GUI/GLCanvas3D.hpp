...
//        float distance_sla       = 6.;
    ...
    int GetHoverId();
    //Meta3D: Get volumes 
    //GLVolumeCollection get_volumes_write(){return m_volumes;}
    Bed3D &m_bed;
private:
...
public:
    ...
    GLVolumeCollection& get_volumes_not_const()  { return m_volumes; } //Meta3D: Super silly function for testing purposes
    void reset_volumes();
